...
const SECTION_DEFS: SectionDef[] = [
  ...
  },
  {
    ...
    title: "Buy box",
    description:
      "PDP presentation defaults (per-plan overrides on the Plans page). Take rate is won here.",
    fields: [
      {
        path: "savingsFormat",
        label: "Savings format",
        helpText:
          "How savings are displayed — showing both % and amount converts best on premium price points.",
        type: "select",
        options: [
          { label: "Percent only", value: "PERCENT" },
          { label: "Amount only", value: "ABSOLUTE" },
          { label: "Both", value: "BOTH" },
        ],
      },
      {
        path: "subscriptionListedFirst",
        label: "List subscription first",
        helpText: "Order bias is real — the first-listed option wins.",
        type: "toggle",
      },
      {
        path: "showReassuranceCopy",
        label: "Show reassurance copy",
        helpText:
          "\"Skip, pause or cancel anytime\" — reassurance measurably lifts take rate without lifting churn.",
        type: "toggle",
      },
    ],
  },
