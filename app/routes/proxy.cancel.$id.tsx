 ...
 * "No thanks, cancel my subscription"). When settings.cancelFlow.enabled is
 * false, this page redirects straight to the offer-free confirm step.
 */
...
export const loader = async ({ request, params }: LoaderFunctionArgs) => {
  ...
  return renderCancelPage(ctx, pageIntro({
    ...
    pauseMonths: Math.min(PAUSE_SUGGEST_MONTHS, pauseSettings.maxMonths),
