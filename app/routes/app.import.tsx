...
/** Bare dates parse at 12:00 UTC so the calendar day survives any shop tz. */
...
async function processGroup(
  ...
  // Idempotency: an email that already has an ACTIVE local contract at this
  // interval was already migrated — never double-import.
