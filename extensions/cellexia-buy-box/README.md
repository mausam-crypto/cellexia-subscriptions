...
snippets/cx-buybox-core.liquid   THE widget, self-contained: config resolution, text resolution,
                                 templating, frequency/save labels, price blocks, all six presets,
                                 JSON island. The ONLY snippet in this extension — see the Liquid
                                 rules below for why it is deliberately one big file.
